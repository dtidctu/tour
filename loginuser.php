...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        //$sql2 = "SELECT fullname FROM tblusers";
        ...
        if ($count == 1) {
            // login success
            $_SESSION['login'] = "<div class='loginsuccess text-center'><h1>Login Successful.</h1></div>";

            // function redirect($url){
            //     if(!empty($url))
            //     header("Location: {$url}");
            // }
            // redirect("index.php?id=$user_id", "Login Successful");

            // $_SESSION['login'] = alertify.success('Success message');
