                        ...
                        <form method="POST" action="" class="row" enctype="multipart/form-data">
                            <table>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <textarea name="description" cols="30" rows="5" class="form-control" type="text"></textarea>
                                </div>
                                <div class="form-group col-md-3">
                                ...
                                <div class="form-group col-md-12">
                                    <input style="width: 85px; border:none;" type="submit" name="submit" value="Thêm" class="btn btn-add btn-sm"></input> &ensp;
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                if (isset($_FILES['image1']['name'])) {
                                    ...
                                    if ($nameimage != "") {
                                        ...
                                        if ($upload == false) {
                                            header('location:' . SITEURL . 'admin/giaodienmoi/doc/form-add-categoty.php');
                                ...
                                // insert data
                                $sql2 = "INSERT INTO tblcategory SET 
            title = '$title',
