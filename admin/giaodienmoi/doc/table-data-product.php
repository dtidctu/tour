...
<head>
  <title>Danh sách tour | Quản trị Admin</title>
  <meta charset="utf-8">
              ...
              <tbody>
                ...
                ?>
                    <tr data-id="<?php echo $id; ?>">
                      ...
                      <td><?php echo $time ?> ngày</td>
                      <td><?php echo $description ?></td>
                      <td><?php echo $price ?></td>
                      <td><?php echo $tourcost ?></td>
                      <td><?php $sql3 = "SELECT * FROM tlbhotel where id = $hotel";
                      ...
                      <td>
                        ...
                        <a href="<?php echo SITEURL; ?>admin/giaodienmoi/doc/form-update-tour.php?id=<?php echo $id; ?>" class="btn btn-primary btn-sm edit" type="button" title="Sửa" id="show-emp"><i class="fas fa-edit"></i></a>
                      </td>
                    </tr>
                  <?php
                  }
  ...
  <script>
    jQuery(function() {
      jQuery(".trash").click(function() {
        ...
        swal({
          title: "Cảnh báo",
          text: "Bạn có chắc chắn là muốn xóa tour này?",
    ...
    function deleteRecord(element) {
      ...
      xhr.open("POST", "form-delete-tour.php", true);
