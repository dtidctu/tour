                ...
                ?>
                    ...
                    <tr data-id="<?php echo $id;?>">
                      ...
                      <td>
                        ...
                        <a href="<?php echo SITEURL; ?>admin/giaodienmoi/doc/form-update-hotel.php?id=<?php echo $id; ?>" class="btn btn-primary btn-sm edit" type="button" title="Sửa" id="show-emp" onclick="setID(<?php echo $id; ?>,<?php echo $time; ?>,<?php echo $price; ?>,'<?php echo $nameimage; ?>','<?php echo $title; ?>','<?php echo $tourcost; ?>','<?php echo $id_categoty; ?>','<?php echo $description; ?>')"><i class="fas fa-edit"></i></a>
                      </td>
                    </tr>
                  <?php
                  }
