...
<head>
  <title>Sửa tour | Quản trị Admin</title>
  <meta charset="utf-8">
  ...
  <main class="app-content">
    <div class="app-title">
      <ul class="app-breadcrumb breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Sửa tour</a></li>
      </ul>
    </div>
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          <h3 class="tile-title">Sửa tour</h3>
          <div class="tile-body">
            ...
            if (isset($_GET['id'])) {
              ...
              if ($count2 == 1) {
                ...
                $sql2 = "SELECT * FROM tlbhotel WHERE id=$hotel";
            ...
            <form method="POST" class="row" enctype="multipart/form-data">
              <div class="form-group col-md-3">
                ...
                <input class="form-control" type="text" name="title" value="<?php echo $title1;  ?>" required>
              </div>


              <div class="form-group  col-md-3">
                <label class="control-label">Ngày</label>
                <input name="time" class="form-control" type="number" value="<?php echo $time;  ?>" required>
              </div>
              <div class="form-group col-md-3 ">
                ...
                <select name="location" id="location" class="form-control" id="exampleSelect1">
                  <?php
                  $sql9 = "SELECT * FROM tbllocation where id=$location";
                  ...
                  if ($count9 > 0) {
                    while ($row9 = mysqli_fetch_array($res9)) {
                      $id2 = $row9['id'];
                      $title_location = $row9['title_location'];

                  ?>
                      <option value="<?php echo $id2; ?>"><?php echo $title_location ?></option>
                      <option>-- Chọn địa điểm mới --</option>
                  ...
                  <?php
                      ...
                      if ($count7 > 0) {
                        while ($row7 = mysqli_fetch_array($res7)) {
                          ...
                          echo '<option value="' . $id5 . '">' . $title_location1 . '</option>';
                        }
                      }
                    }
                  }
              ...
              <div class="form-group col-md-3">
                ...
                <select name="category" class="form-control" id="exampleSelect1">
                  ...
                  ?>
                      <option value="<?php echo $id1; ?>"><?php echo $title2; ?></option>
                      <option>-- Chọn danh mục mới --</option>
              ...
              <div class="form-group col-md-3 ">
                <label for="exampleSelect1" class="control-label">Khách sạn hiện tại</label>
                <input type="text" class="form-control" value="<?php echo $name_hotel ?>">
              </div>
              <div class="form-group col-md-3 ">
                <label for="exampleSelect1" class="control-label">Khách sạn mới</label>
                <select class="form-control" name="hotel1" id="hotel"></select>
              </div>
              <div class="form-group col-md-3">
                <label class="control-label">Chi phí tour</label>
                <input class="form-control" type="number" name="tourcost" value="<?php echo $tourcost;  ?>" required>
              </div>
              <div class="form-group col-md-3">
              ...
              <div class="form-group col-md-3">
                ...
                <br><br>
                <input style="width: 85px; border:none;" type="submit" name="submit" value="Lưu tour" class="btn btn-add btn-sm"></input> &ensp;
