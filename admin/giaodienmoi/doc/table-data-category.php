          ...
          <div class="tile-body">
            <div class="row element-button">
              <div class="col-sm-2">
                ...
                <a class="btn btn-add btn-sm" href="form-add-category.php" title="Thêm"><i class="fas fa-plus"></i>
                  Tạo danh mục mới</a>
              </div>
              <div class="col-sm-2">
                  ...
                  ?>
                    <tr data-id="<?php echo $id; ?>">
                      ...
                      <td><?php
                          if ($nameimage != "") {
                          ?>
                          <img src="images/tour/<?php echo $nameimage; ?>" width="110px" height="80px">
                      ...
                      <td>
                        ...
                        <a href="<?php echo SITEURL; ?>admin/giaodienmoi/doc/form-update-category.php?id=<?php echo $id; ?>" class="btn btn-primary btn-sm edit" type="button" title="Sửa" id="show-emp" onclick="setID(<?php echo $id; ?>,<?php echo $time; ?>,<?php echo $price; ?>,'<?php echo $nameimage; ?>','<?php echo $title; ?>','<?php echo $tourcost; ?>','<?php echo $id_categoty; ?>','<?php echo $description; ?>')"><i class="fas fa-edit"></i></a>
                      </td>
                    </tr>
                  <?php
                  }
...
-->
  ...
  <script>
    ...
    function deleteRecord(element) {
      ...
      xhr.open("POST", "form-delete-category.php", true);
